...
ghcr_manifest=$(curl -H "Authorization: Bearer $(echo $GITHUB_TOKEN | base64)" -H "Accept: application/vnd.docker.distribution.manifest.list.v2+json" https://ghcr.io/v2/${image_i}/manifests/${image_t} 2>/dev/null)
echo "ghcr manifest:"
echo $ghcr_manifest
